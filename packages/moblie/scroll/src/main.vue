...
export default {
    ...
    props: {
        ...
        mouseWheel: {
            type: Boolean,
            default: !(/Android|webOS|iPhone|iPod|BlackBerry|htoa/i.test(navigator.userAgent))
        },
        bounce: {
            default: true
        },
    ...
    computed: {
        pullUpTxt() {
            const moreTxt = get(this.pullUpLoad, 'txt.more', '')

            const noMoreTxt = get(this.pullUpLoad, 'txt.noMore', '')
